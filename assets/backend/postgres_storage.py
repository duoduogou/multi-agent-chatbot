...
class PostgreSQLConversationStorage:
    ...
    def _message_to_dict(self, message: BaseMessage) -> Dict:
        ...
        # Scrub internal RAG context from UI display
        content = message.content
        if isinstance(content, str) and "[SYSTEM INJECTED CONTEXT from Knowledge Base]" in content:
            content = content.split("\n\n[SYSTEM INJECTED CONTEXT from Knowledge Base]")[0]
